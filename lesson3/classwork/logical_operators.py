...
# logical operators turn true or false back into true or false

age = int(input("How old are you: "))
has_ticket = input("Do you have a movie ticket? (yes/no)")

if age >= 23 and has_ticket == "yes":
    print("You can enter the PG-13 movie.")
else:
    print("Sorry, you can't enter")
print("Movie chck complete!")
...
homework_done = input("Did you do yor homework? (yes/no)")

if not homework_done == "yes":
    print("Go finish your homework")
else:
    ("Nice job! you're all done")
